    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-neutral-50 dark:bg-neutral-950">
      ...
      >
        <div className="text-center mb-10">
          ...
          >
            <Image src="/Vault.png" alt="Vault logo" width={96} height={96} className="rounded-[10px] object-contain" />
          </motion.div>
          <motion.h1
            ...
            <div className="relative flex items-center justify-center gap-3">
              {loading ? (
                ...
                <svg className="h-5 w-5 shrink-0" viewBox="0 0 24 24">
                  <path fill="#404040" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" />
                  ...
                  <path fill="#171717" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" />
                </svg>
              )}
